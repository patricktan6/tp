...
public class LogicManagerTest {
    ...
    public void execute_commandExecutionError_throwsCommandException() {
        String lessonDeleteCommand = "lesson_delete 9";
        assertCommandException(lessonDeleteCommand, MESSAGE_INVALID_LESSON_DISPLAYED_INDEX);
    }

    @Test
    public void execute_validCommand_success() throws Exception {
        String lessonListCommand = LessonListCommand.COMMAND_WORD;
        assertCommandSuccess(lessonListCommand, LessonListCommand.MESSAGE_SUCCESS, model);
    }
    ...
    public void execute_storageThrowsIoException_throwsCommandException() {
        ...
        // Execute lesson add command
        String lessonAddCommand = LessonAddCommand.COMMAND_WORD + LESSON_NAME_DESC_CS2030;
        ...
        assertCommandFailure(lessonAddCommand, CommandException.class, expectedMessage, expectedModel);
    }
